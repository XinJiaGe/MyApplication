...
public class MainActivity extends BaseActivity {
    ...
    public void doBusiness() {
        ...
        list.add(new MainEntity().setName("指纹识别").setClz(FingerprintActivity.class));
        list.add(new MainEntity().setName("Kotlin").setClz(KotlinActivity.class));
...
//        list.add(new MainEntity().setName("Messenger").setClz(MessengerActivity.class));
        ...
        list.add(new MainEntity().setName("锁柜").setClz(LockActivity.class));

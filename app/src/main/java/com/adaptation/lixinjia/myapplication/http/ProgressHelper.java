...
public class ProgressHelper {
     ...
     * @return 包装后的进度回调请求体
     */
    public static ProgressRequestBody addProgressRequestListener(RequestBody requestBody, ProgressRequestBody.ProgressRequestListener progressRequestListener){
        //包装请求体

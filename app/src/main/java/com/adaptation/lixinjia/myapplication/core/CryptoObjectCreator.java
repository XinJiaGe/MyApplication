...
public class CryptoObjectCreator {
            ...
            public void run() {
                try {
                    if (mCryptoObject != null) {
                        ...
                        // of the fingerprint.
                        if (!initCipher()) {
                            Log.d("CryptoObjectCreator","初始化密码失败.");
                        }
                    }
                } catch (Exception e) {
                    Log.d("CryptoObjectCreator","初始化密码失败, e:" + Log.getStackTraceString(e));
                }
    ...
    private void createKey() {
        ...
        try {
            ...
            Log.d("CryptoObjectCreator"," 没有createkey, e:" + Log.getStackTraceString(e));
    ...
    private boolean initCipher() {
        try {
            ...
            Log.d("CryptoObjectCreator"," 没有initcipher, e:" + Log.getStackTraceString(e));
            return false;
        } catch (KeyStoreException | CertificateException | UnrecoverableKeyException | IOException
                | NoSuchAlgorithmException | InvalidKeyException e) {
            Log.d("CryptoObjectCreator"," 没有initcipher, e :" + Log.getStackTraceString(e));
            throw new RuntimeException("没有initcipher", e);
        }
    }
